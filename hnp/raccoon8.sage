...
outputs = os.path.abspath("output8")
...
experiments = [
  # dh, k, d, bs, fudge
  (dh2048, 12, 180, 40, fudge),
  (dh2048, 12, 190, 40, fudge),
  (dh2048, 12, 200, 40, fudge),
  (dh2048, 12, 210, 40, fudge),
  (dh2048, 12, 220, 40, fudge),
  (dh2048, 12, 230, 40, fudge),
  (dh2048, 12, 240, 40, fudge),
  (dh2048, 12, 180, 50, fudge),
  (dh2048, 12, 190, 50, fudge),
  (dh2048, 12, 200, 50, fudge),
  (dh2048, 12, 210, 50, fudge),
  (dh2048, 12, 220, 50, fudge),
  (dh2048, 12, 230, 50, fudge),
  (dh2048, 12, 240, 50, fudge),
  (dh2048, 12, 180, 60, fudge),
  (dh2048, 12, 190, 60, fudge),
  (dh2048, 12, 200, 60, fudge),
  (dh2048, 12, 210, 60, fudge),
  (dh2048, 12, 220, 60, fudge),
  (dh2048, 12, 230, 60, fudge),
  (dh2048, 12, 240, 60, fudge),

  (dh2048, 16, 130, 40, fudge),
  (dh2048, 16, 140, 40, fudge),
  (dh2048, 16, 150, 40, fudge),
  (dh2048, 16, 160, 40, fudge),
  (dh2048, 16, 130, 50, fudge),
  (dh2048, 16, 140, 50, fudge),
  (dh2048, 16, 150, 50, fudge),
  (dh2048, 16, 160, 50, fudge),
  (dh2048, 16, 130, 60, fudge),
  (dh2048, 16, 140, 60, fudge),
  (dh2048, 16, 150, 60, fudge),
  (dh2048, 16, 160, 60, fudge),
]
