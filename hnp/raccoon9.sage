...
outputs = os.path.abspath("output9")
...
experiments = [
  # dh, k, d, bs, fudge
  (dh4096, 24, 170, 40, fudge),
  (dh4096, 24, 180, 40, fudge),
  (dh4096, 24, 190, 40, fudge),
  (dh4096, 24, 200, 40, fudge),
  (dh4096, 24, 210, 40, fudge),
  (dh4096, 24, 220, 40, fudge),
  (dh4096, 24, 230, 40, fudge),
  (dh4096, 24, 240, 40, fudge),
  (dh4096, 24, 250, 40, fudge),
  (dh4096, 24, 170, 50, fudge),
  (dh4096, 24, 180, 50, fudge),
  (dh4096, 24, 190, 50, fudge),
  (dh4096, 24, 200, 50, fudge),
  (dh4096, 24, 210, 50, fudge),
  (dh4096, 24, 220, 50, fudge),
  (dh4096, 24, 230, 50, fudge),
  (dh4096, 24, 240, 50, fudge),
  (dh4096, 24, 250, 50, fudge),
  (dh4096, 24, 170, 60, fudge),
  (dh4096, 24, 180, 60, fudge),
  (dh4096, 24, 190, 60, fudge),
  (dh4096, 24, 200, 60, fudge),
  (dh4096, 24, 210, 60, fudge),
  (dh4096, 24, 220, 60, fudge),
  (dh4096, 24, 230, 60, fudge),
  (dh4096, 24, 240, 60, fudge),
  (dh4096, 24, 250, 60, fudge),

  (dh4096, 20, 200, 40, fudge),
  (dh4096, 20, 210, 40, fudge),
  (dh4096, 20, 220, 40, fudge),
  (dh4096, 20, 230, 40, fudge),
  (dh4096, 20, 240, 40, fudge),
  (dh4096, 20, 250, 40, fudge),
  (dh4096, 20, 200, 50, fudge),
  (dh4096, 20, 210, 50, fudge),
  (dh4096, 20, 220, 50, fudge),
  (dh4096, 20, 230, 50, fudge),
  (dh4096, 20, 240, 50, fudge),
  (dh4096, 20, 250, 50, fudge),
  (dh4096, 20, 200, 60, fudge),
  (dh4096, 20, 210, 60, fudge),
  (dh4096, 20, 220, 60, fudge),
  (dh4096, 20, 230, 60, fudge),
  (dh4096, 20, 240, 60, fudge),
  (dh4096, 20, 250, 60, fudge),
