...
outputs = os.path.abspath("output11")
...
experiments = [
  # dh, k, d, bs, fudge
  (dh2048, 11, 250, 60, fudge),
  (dh2048, 11, 260, 60, fudge),
  (dh2048, 11, 270, 60, fudge),
  (dh2048, 11, 280, 60, fudge),
  (dh2048, 11, 290, 60, fudge),
  (dh2048, 11, 300, 60, fudge),
  (dh2048, 11, 310, 60, fudge),
  (dh2048, 11, 320, 60, fudge),

  (dh2048, 10, 250, 60, fudge),
  (dh2048, 10, 260, 60, fudge),
  (dh2048, 10, 270, 60, fudge),
  (dh2048, 10, 280, 60, fudge),
  (dh2048, 10, 290, 60, fudge),
  (dh2048, 10, 300, 60, fudge),
  (dh2048, 10, 310, 60, fudge),
  (dh2048, 10, 320, 60, fudge),

  (dh2048, 9, 280, 60, fudge),
  (dh2048, 9, 290, 60, fudge),
  (dh2048, 9, 300, 60, fudge),
  (dh2048, 9, 310, 60, fudge),
  (dh2048, 9, 320, 60, fudge),
  (dh2048, 9, 330, 60, fudge),
  (dh2048, 9, 340, 60, fudge),
  (dh2048, 9, 350, 60, fudge),

  (dh2048, 11, 250, 70, fudge),
  (dh2048, 11, 260, 70, fudge),
  (dh2048, 11, 270, 70, fudge),
  (dh2048, 11, 280, 70, fudge),
  (dh2048, 11, 290, 70, fudge),
  (dh2048, 11, 300, 70, fudge),
  (dh2048, 11, 310, 70, fudge),
  (dh2048, 11, 320, 70, fudge),

  (dh2048, 10, 250, 70, fudge),
  (dh2048, 10, 260, 70, fudge),
  (dh2048, 10, 270, 70, fudge),
  (dh2048, 10, 280, 70, fudge),
  (dh2048, 10, 290, 70, fudge),
  (dh2048, 10, 300, 70, fudge),
  (dh2048, 10, 310, 70, fudge),
  (dh2048, 10, 320, 70, fudge),

  (dh2048, 9, 280, 70, fudge),
  (dh2048, 9, 290, 70, fudge),
  (dh2048, 9, 300, 70, fudge),
  (dh2048, 9, 310, 70, fudge),
  (dh2048, 9, 320, 70, fudge),
  (dh2048, 9, 330, 70, fudge),
  (dh2048, 9, 340, 70, fudge),
  (dh2048, 9, 350, 70, fudge),
