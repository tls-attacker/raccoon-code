...
outputs = os.path.abspath("output4")

RR = RealField(100)

os.environ["SAGE_NUM_THREADS"] = "24"
...
experiments = [
  # dh, k, d, bs, fudge
  (dh1024, 24, 50, 40, fudge),
  (dh1036, 24, 50, 40, fudge),
  (dh1024, 20, 60, 40, fudge),
  (dh1036, 20, 60, 40, fudge),
  (dh1024, 16, 80, 40, fudge),
  (dh1036, 16, 80, 40, fudge),
  (dh1036, 12, 100, 40, fudge),
  (dh1024, 12, 100, 40, fudge)
]
